...
---
In the first two posts, we've gone over how to build your own DNS "smart" proxy, like Unlocator and UnblockUS. We covered the basics concepts and how to get a minimum viable product in [Part 1]({{ site.baseurl }}{% post_url 2017-01-02-building-your-own-dns-proxy-part-1 %}), and then extended that into a more robust version in [Part 2]({{ site.baseurl }}{% post_url 2017-01-18-building-your-own-dns-proxy-part-2 %}). We're going to take it one step further and turn it into a one-click deploy using Jenkins.
